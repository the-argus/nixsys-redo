# this file configures and enables kitty only if config.desktops.terminal.name
# is "kitty"
# the package it installs is config.desktops.terminal.
{config, ...}: {
  programs.kitty = let
  ...
  in {
    enable = config.desktops.terminal.name == "kitty";
    package = config.desktops.terminal;

# This file just creates a configuration file for rofi and places it in the
# correct config directory. If the system font is one that is set up to be
# replaced because it doesn't look good in rofi, it will install the replacement
# font.
{
  pkgs,
  config,

{
  ...
  options.programs.blugon.enable = lib.mkEnableOption "Install and autostart blugon to orange-tint the screen in X sessions.";
  ...
  in
    lib.mkIf config.programs.blugon.enable {
